              ...
              rows.slice(0, 32).map((row, idx) => (
                <div
                  ...
                  style={{
                    ...
                    fontSize: "20px",
                    background:
                      idx % 2 === 0 ? "rgba(20,33,61,0.02)" : "transparent",
                    borderTop: "1px solid rgba(20,33,61,0.08)",
                  }}
                >
                  <div style={{ width: "33%", fontWeight: 700 }}>
                    {row.name}
                  </div>
                  <div style={{ width: "9.57%", textAlign: "center" }}>
                    {row.gp}
                  </div>
                  <div style={{ width: "9.57%", textAlign: "center" }}>
                    {row.goals}
