...
function goaliePoints(entry: Entry, redScore: number, blueScore: number) {
  ...
  const won =
    entry.team === "Red" ? redScore > blueScore : blueScore > redScore;
          ...
          >
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ fontSize: "38px", fontWeight: 800 }}>
                Game Recap - {formatDate(game.date)}
              </div>
              ...
              >
                ...
                {(team.players.length ? team.players : [])
                  ...
                  .map((row, idx) => (
                    ...
                    >
                      <div style={{ width: "48%", fontWeight: 600 }}>
                        {row.name}
                      </div>
                ...
                {(team.goalies.length ? team.goalies : [])
                  .slice(0, 6)
                  .map((goalie, idx) => (
                    <div
                      key={`${goalie.id}-g-${idx}`}
                    ...
                    >
                      ...
                      <span>
                        A: {safeNumber(goalie.assists)} | PTS:{" "}
                        {goaliePoints(goalie, game.redScore, game.blueScore)}
                      </span>
                    </div>
                  ))}
                {!team.goalies.length ? (
